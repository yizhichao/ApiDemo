#import "GA_ARO_HTTPSessionManager+Synchronous.h"

@interface GA_ARO_HTTPSessionManager (Private)
...
@implementation GA_ARO_HTTPSessionManager (Synchronous)
...
- (id)synchronouslyPerformMethod:(NSString *)method
    ...
    // completion handler:
    //
    // manager.completionQueue = dispatch_queue_create("GA_ARO_Networking+Synchronous", NULL);
    //
    ...
    // https://github.com/GA_ARO_Networking/GA_ARO_Networking/issues/1804#issuecomment-100396741
