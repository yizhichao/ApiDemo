...
/**
 A minimal category which extends GA_ARO_HTTPSessionManager to support
 synchronous requests.

 **This category is for GA_ARO_Networking 3.x.**
*/
@interface GA_ARO_HTTPSessionManager (Synchronous)
